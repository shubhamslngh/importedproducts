...
import {
  ...
  markdownSpace
} from "./chunk-VKCLFBAU.js";
import "./chunk-FYL5NBX3.js";
import {
  visit
} from "./chunk-5AEX43UR.js";
import "./chunk-NBAZHKWN.js";
...
// node_modules/remark-mdc/node_modules/flat/index.js
...
${content(node, context)}`.trim();
  ...
  function containerComponent(node, _, context) {
    ...
    if (Object.keys(fmAttributes).length > 0) {
      const attrs = Object.entries(fmAttributes).reduce((acc, [key2, value2]) => {
...
var attributes$3 = { tokenize: tokenizeAttributes$3, partial: true };
