import { b as useRuntimeConfig, l as useRequestEvent } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///Users/shubhamsingh/namma/importedProds/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-DGftJOwZ.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-Qn0gMuuU.mjs.map
