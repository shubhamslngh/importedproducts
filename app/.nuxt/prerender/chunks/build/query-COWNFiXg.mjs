import { f as useRuntimeConfig, k as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BBPdojnX.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-COWNFiXg.mjs.map
