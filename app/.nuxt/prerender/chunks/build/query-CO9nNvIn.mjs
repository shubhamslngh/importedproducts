import { b as useRuntimeConfig, k as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Cox1Ib-w.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CO9nNvIn.mjs.map
