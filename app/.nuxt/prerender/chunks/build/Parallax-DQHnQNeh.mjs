...
import { ssrRenderAttrs, ssrRenderList, ssrRenderStyle, ssrRenderAttr, ssrRenderComponent } from 'file:///Users/shubhamsingh/namma/importedProds/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    ...
    ref: "flexContainer"
  }, _attrs))} data-v-fbd81939><!--[-->`);
  ssrRenderList($data.products, (product) => {
    _push(`<div class="flex-item" style="${ssrRenderStyle(product.style)}" data-v-fbd81939><img${ssrRenderAttr("src", product.imageUrl)}${ssrRenderAttr("alt", product.name)} class="product-image" data-v-fbd81939><div class="flex-item z-20" data-v-fbd81939>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fbd81939"]]);

export { __nuxt_component_2 as default };
//# sourceMappingURL=Parallax-DQHnQNeh.mjs.map
