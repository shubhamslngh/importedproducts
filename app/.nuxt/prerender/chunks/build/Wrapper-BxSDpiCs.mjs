import { u as useNavbarParser, _ as _sfc_main$1 } from './Item-WKVZeniT.mjs';
import { defineComponent, provide, ref, computed, inject, onMounted, watchEffect, getCurrentInstance, watch, onUnmounted, h, Teleport, reactive, Fragment, shallowRef, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, renderList, Transition, useSSRContext } from 'file:///Users/shubhamsingh/namma/importedProds/node_modules/vue/index.mjs';
import { A as A$1, o, u, I, N as N$1, c } from './env-CWaVQ5oT.mjs';
import { i, E as E$1, w as w$1, h as h$1, a as s$1, f, s as s$2, P, N as N$2, o as o$1, T } from './focus-management-je2kZWzN.mjs';
import { w, a as w$1$1 } from './use-outside-click-Do9_uFVP.mjs';
import { t, i as i$1, l } from './open-closed-BDzQJ33n.mjs';
import __nuxt_component_1 from './Icon-BLSQvnWJ.mjs';
import { i as useRoute, a as useRouter } from './server.mjs';
import { ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList } from 'file:///Users/shubhamsingh/namma/importedProds/node_modules/vue/server-renderer/index.mjs';
import './nuxt-link-DuPix_nQ.mjs';
import 'file:///Users/shubhamsingh/namma/importedProds/node_modules/ufo/dist/index.mjs';
import './index-zPKawY5Q.mjs';
...
function N({ defaultContainers: o$12 = [], portals: i$12, mainTreeNodeRef: H } = {}) {
  ...
  return { resolveContainers: u2, contains(n2) {
    ...
    return H != null ? null : h(f, { features: s$2.Hidden, ref: t2 });
  } };
}
function v() {
  let o2 = ref(null);
  return { mainTreeNodeRef: o2, MainTreeNode() {
    return h(f, { features: s$2.Hidden, ref: o2 });
  } };
}
...
let ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { slots: P2, attrs: s2, expose: h$2 }) {
  ...
  }, true), w(i$2.resolveContainers, (e2, r) => {
    var l2;
    a.closePopover(), w$1(r, h$1.Loose) || (e2.preventDefault(), (l2 = o(o$12)) == null || l2.focus());
  ...
  let S = s$1(computed(() => ({ as: d$1.as, type: P$1.type })), E2);
  function c2(e2) {
    var r, l2, g, G, C2;
    if (b.value) {
  ...
  return () => {
    ...
    return h(Fragment, [A$1({ ourProps: g, theirProps: { ...P$1, ...l2 }, slot: r, attrs: P$1, slots: s2, name: "PopoverButton" }), e2 && !b.value && t2.isPortalled.value && h(f, { id: a, features: s$2.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: p })]);
  };
} });
...
let je = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d$1, { attrs: P$1, slots: s2, expose: h$12 }) {
  ...
  return () => {
    ...
    return A$1({ ourProps: e2, theirProps: { ...P$1, ...u2 }, attrs: P$1, slot: i2, slots: { ...s2, default: (...r) => {
      var l2;
      return [h(Fragment, [E2.value && o$2.isPortalled.value && h(f, { id: v2, ref: o$2.beforePanelSentinel, features: s$2.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: I$1 }), (l2 = s2.default) == null ? void 0 : l2.call(s2, ...r), E2.value && o$2.isPortalled.value && h(f, { id: m2, ref: o$2.afterPanelSentinel, features: s$2.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: F })])];
...
//# sourceMappingURL=Wrapper-BxSDpiCs.mjs.map
