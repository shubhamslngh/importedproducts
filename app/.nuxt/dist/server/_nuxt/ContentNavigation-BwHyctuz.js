import { b as useRuntimeConfig, p as useState, j as useAsyncData } from "../server.mjs";
import { hash } from "ohash";
import { q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify, u as useContentDisabled } from "./query-CO9nNvIn.js";
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./client-db-Cox1Ib-w.js").then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BwHyctuz.js.map
