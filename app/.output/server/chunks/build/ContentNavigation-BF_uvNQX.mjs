import { m as useState, j as useAsyncData, f as useRuntimeConfig } from './server.mjs';
import { r as hash } from '../runtime.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-COWNFiXg.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BBPdojnX.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BF_uvNQX.mjs.map
