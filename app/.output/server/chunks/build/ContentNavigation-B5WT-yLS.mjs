import { p as useState, i as useAsyncData, b as useRuntimeConfig } from './server.mjs';
import { r as hash } from '../runtime.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-Br-_9uEw.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CfACG3Oy.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-B5WT-yLS.mjs.map
