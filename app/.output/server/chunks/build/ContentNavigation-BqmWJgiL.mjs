import { p as useState, k as useAsyncData, b as useRuntimeConfig } from './server.mjs';
import { r as hash } from '../runtime.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-Qn0gMuuU.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-DGftJOwZ.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BqmWJgiL.mjs.map
